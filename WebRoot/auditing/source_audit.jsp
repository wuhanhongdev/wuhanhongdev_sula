...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
%>
<span ng-controller="sourceAudit">
	<div class="sula-right-title">
		<strong class="am-text-primary title-text"><span
			class="am-icon-cube"></span> 货源审核</strong> / <small>审核APP用户提交的成为货源的申请</small>
	</div>
			...
			<div class="am-u-sm-12 am-u-md-12">
				<div class="am-btn-toolbar">
					<div class="am-btn-group">
						...
						<div class="am-btn-group">
						<button type="button" class="am-btn am-btn-romantic"
							ng-click="auditrebut()">
							<span class="am-icon-trash-o"></span> 审核驳回
						</button>
					</div>
				</div>
			</div>
							...
							<td>
								<div class="am-btn-toolbar">
									<div class="am-btn-group am-btn-group-xs">
										<button type="button"
											data-am-modal="{target: '#doc-modal-1', width:1000,height:500}"
											class="am-btn am-btn-default am-btn-xs"
											ng-click="lookup(datalist.id)">
											<i class="am-icon-pencil-square-o"></i> 查看
										</button>
									</div>
								</div>
							</td>
			...
			<div class="am-modal-bd">
				...
				<div class="am-g am-margin-top">
					<div class="am-u-sm-6 am-text-left">
						<strong style="width:180px; display:inline-block"
							class="am-text-right">昵称：</strong>{{nick_name}}
					</div>
					<div class="am-u-sm-6 am-text-left">
						<strong style="width:180px; display:inline-block"
							class="am-text-right">手机：</strong>{{mobile_}}
					</div>
				</div>
				...
				<div class="am-g am-margin-top">
					<div class="am-u-sm-6 am-text-left">
						<strong style="width:180px; display:inline-block"
							class="am-text-right">身份证照片：</strong><img ng-src="{{img_img1}}"
							width="240" ; height="120" alt="" />
					</div>
					<div class="am-u-sm-6 am-text-left">
						<strong style="width:180px; display:inline-block"
							class="am-text-right">营业执照：</strong><img ng-src="{{img_img2]}"
							width="240" ; height="120" alt="" />
					</div>
				</div>
