...
<span ng-controller="advertController">
	<div class="sula-right-title">
		<strong class="am-text-primary title-text"><span
			class="am-icon-picture-o"></span> 广告管理</strong> / <small>管理员添加广告，在APP做推广用途</small>
	</div>
				...
				<div class="am-btn-toolbar">
					<div class="am-btn-group">
						...
						<button type="button" class="am-btn am-btn-warning"
							...
							<span class="am-icon-reply"></span> 修改广告
						</button>
						</div>
						<div class="am-btn-group">
						<button type="button" class="am-btn am-btn-danger"
							ng-click="delAdvert()">
							<span class="am-icon-trash-o"></span> 删除广告
						</button>
					</div>
				</div>
			</div>
