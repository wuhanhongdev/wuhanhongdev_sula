...
<span ng-controller="assistController">
	<div class="sula-right-title">
		<strong class="am-text-primary title-text"><span
			class="am-icon-tags"></span> 帮助信息</strong> / <small>管理员添加资讯信息，为APP用户提供参考</small>
	</div>
				...
				<div class="am-btn-toolbar">
					<div class="am-btn-group">
						<button type="button" class="am-btn am-btn-success"
							...
							ng-click="addAdvert()">
							<span class="am-icon-plus"></span> 添加帮助
						</button>
						</div>
						<div class="am-btn-group">
						<button type="button" class="am-btn am-btn-warning"
							ng-click="updateAdvert()">
							<span class="am-icon-reply"></span> 修改帮助
						</button>
						</div>
						<div class="am-btn-group">
						<button type="button" class="am-btn am-btn-danger"
							ng-click="delAdvert()">
							<span class="am-icon-trash-o"></span> 删除帮助
						</button>
					</div>
				</div>
			</div>
