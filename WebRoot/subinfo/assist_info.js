...
*咨询管理 2017年6月27日 
**/
app.controller('assistController', function($scope, $http) {
...
//	var _checkrebut = function(id){};
	...
	//获取对象
	var _getAssist = function(id){
		$http({
			method : 'POST',
			url : 'subinfo/getAssistById',
			data : {'id':id},
			headers: {  
		        'Content-Type': 'application/x-www-form-urlencoded'  
		    },  
	...
	$scope.submitAdvert = function(){
		...
		if(data.id == null){
			_save(data,'subinfo/addAssist');
		}else{
			_save(data,'subinfo/updateAssist');
		}
	};
